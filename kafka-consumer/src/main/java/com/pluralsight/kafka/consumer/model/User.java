...
public class User extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3677208409903127350L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"User\",\"namespace\":\"com.example.kafka.model\",\"fields\":[{\"name\":\"userId\",\"type\":\"string\"},{\"name\":\"username\",\"type\":\"string\"},{\"name\":\"dateOfBirth\",\"type\":\"int\",\"logicalType\":\"date\"}]}");
   ...
   */
  public static com.pluralsight.kafka.consumer.model.User.Builder newBuilder() {
    return new com.pluralsight.kafka.consumer.model.User.Builder();
  }
   ...
   * @return A new User RecordBuilder
   */
  public static com.pluralsight.kafka.consumer.model.User.Builder newBuilder(com.pluralsight.kafka.consumer.model.User.Builder other) {
    if (other == null) {
      return new com.pluralsight.kafka.consumer.model.User.Builder();
    } else {
      return new com.pluralsight.kafka.consumer.model.User.Builder(other);
    }
  }
   ...
   * @return A new User RecordBuilder
   */
  public static com.pluralsight.kafka.consumer.model.User.Builder newBuilder(com.pluralsight.kafka.consumer.model.User other) {
    if (other == null) {
      return new com.pluralsight.kafka.consumer.model.User.Builder();
    } else {
      return new com.pluralsight.kafka.consumer.model.User.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<User>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pluralsight.kafka.consumer.model.User.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pluralsight.kafka.consumer.model.User other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.kafka.consumer.model.User.Builder setUserId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.kafka.consumer.model.User.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.kafka.consumer.model.User.Builder setUsername(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.kafka.consumer.model.User.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.kafka.consumer.model.User.Builder setDateOfBirth(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.kafka.consumer.model.User.Builder clearDateOfBirth() {
